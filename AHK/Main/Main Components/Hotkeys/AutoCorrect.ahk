...
#h::toggleGUI(ACToggle, "AC", AC_WIDTH, AC_HEIGHT, AC_TITLE)

openInVSCode:
    Run, "C:/Users/%A_UserName%/AppData/Roaming/Microsoft/Windows/Start Menu/Programs/Visual Studio Code/Visual Studio Code.lnk" "%A_ScriptDir%/Main Components/Hotkeys/AutoCorrect.ahk"
    Run, "C:/Users/%A_UserName%/AppData/Roaming/Microsoft/Windows/Start Menu/Programs/Visual Studio Code/Visual Studio Code.lnk" "%A_ScriptDir%/Main Components/Hotkeys/Temp Hotstrings.ahk"
return
...
acFinishBtnClick:
	...
	if (TmpCheck)
    {
		...
		FileAppend, %NewHotstring% %msg%`n, %A_ScriptDir%/Main Components/Hotkeys/Temp Hotstrings.ahk
    }
	else
		FileAppend, %NewHotstring%`n, %A_ScriptDir%/Main Components/Hotkeys/AutoCorrect.ahk ; Put a `n at the beginning in case file lacks a blank line at its end.

	Reload ;Apply the new hotstring.
return
...
::optimaztion::optimization
::anazyle::analyze
::powerufl::powerful
::tht::that
::throughouyt::throughout
::falacies::fallacies
::povertyl::poverty
:*:hokah::Hokah
::pm::PM
