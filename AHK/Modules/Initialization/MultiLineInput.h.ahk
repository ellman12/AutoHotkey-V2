...
newInput(title, prompt, width, height) {
    ...
    Gui, MLI:Add, Edit, vMLIInput xp yp+25 w%width% h%height% -VScroll

    Gui, MLI:Font, s11
    Gui, MLI:Add, Button, +Center xp yp+185 h30 w55 gmliOK, OK
    Gui, MLI:Add, Button, +Center xp+66 yp h30 w55 gmliCancel, Cancel
